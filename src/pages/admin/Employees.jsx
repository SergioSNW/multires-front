    ...
    try {
      const res = await fetch("/api/v1/employees", {
        ...
        body: JSON.stringify({
          name: newEmployee.name,
          role: newEmployee.role,
          scheduleRRule: "FREQ=DAILY;BYHOUR=09,10,11,12,13,14,15,16,17,18", // ← Barber general!
          durationDefault: 30,    // Minutos servicio ¿¿??
  ...
  return (
    <div className="max-w-6xl p-8 mx-auto">
      ...
      <form
        ...
        className="max-w-md p-8 mb-8 bg-white shadow-xl rounded-2xl"
      >
        <input
          type="text"
          placeholder="Nombre"
